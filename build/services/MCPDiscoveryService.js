 ...
 * @returns 工具列表
 */
async function fetchToolsViaStdio(command, cwd = process.cwd()) {
...
export class MCPDiscoveryService {
     ...
     * 通过HTTP获取服务工具列表
     */
    async fetchToolsViaHttp(service) {
        try {
     ...
     * 调用外部MCP服务的工具
     */
    async callExternalTool(toolName, serviceName, params) {
     ...
     * 通过HTTP调用工具
     */
    async callToolViaHttp(service, toolName, params) {
        try {
            const response = await axios.post(service.endpoint, {
                method: 'call_tool',
                params: {
     ...
     * 通过Stdio调用工具
     */
    async callToolViaStdio(service, toolName, params) {
        try {
            // 解析endpoint中的命令
            let command = '';
            let cwd = process.cwd();
...
//# sourceMappingURL=MCPDiscoveryService.js.map