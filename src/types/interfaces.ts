...
export interface Task {
  ...
  entities?: string[]; // 识别的实体名称
  subTasks?: string[]; // 可能的子任务
  priority?: number; // 任务优先级 1-5
...
export interface ContextManager {
  ...
  trackToolUsage(taskId: string, toolUsage: { name: string; inputs?: any; outputs?: any; success?: boolean }): Promise<void>;
